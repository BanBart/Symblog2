...
class Blog extends \Blogger\BlogBundle\Entity\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'id', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'title', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'author', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'blog', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'image', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'tags', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'created_at', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'updated_at', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'comments');
        }
