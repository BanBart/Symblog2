...
class Comment extends \Blogger\BlogBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'username', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'comment', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'approved', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'created_at', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'updated_at', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Comment' . "\0" . 'blog');
        }
