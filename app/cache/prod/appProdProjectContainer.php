...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'blogger_blog.form.type.enquiry' => 'getBloggerBlog_Form_Type_EnquiryService',
    ...
    protected function getBloggerBlog_Form_Type_EnquiryService()
    {
        return $this->services['blogger_blog.form.type.enquiry'] = new \Blogger\BlogBundle\Form\Type\Enquiry();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_e481dea67de7970952686b9f52c0da7bdd72db06ea0e9c183bd3b24e1e60b328');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e481dea67de7970952686b9f52c0da7bdd72db06ea0e9c183bd3b24e1e60b328');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e481dea67de7970952686b9f52c0da7bdd72db06ea0e9c183bd3b24e1e60b328');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\Symblog\\src\\Blogger\\BlogBundle\\Entity')), 'Blogger\\BlogBundle\\Entity');
        ...
        $e->setProxyDir('C:/xampp/htdocs/Symblog/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Symblog/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Symblog/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Symblog/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Symblog/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Symblog/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Symblog/app/cache/prod',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Symblog/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/xampp/htdocs/Symblog/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Symblog/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Symblog/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Symblog/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Symblog/app/cache/prod/doctrine/orm/Proxies',
