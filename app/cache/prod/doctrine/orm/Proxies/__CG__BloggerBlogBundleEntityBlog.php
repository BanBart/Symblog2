...
class Blog extends \Blogger\BlogBundle\Entity\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'id', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'title', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'author', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'blog', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'image', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'tags', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'created_at', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'updated_at', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'comments', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Blog' . "\0" . 'slug');
        }
     ...
     * {@inheritDoc}
     */
    public function setComments(\Blogger\BlogBundle\Entity\Comment $comment)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setComments', array($comment));

        return parent::setComments($comment);
    }
